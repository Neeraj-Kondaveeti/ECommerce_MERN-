...
const Footer = () => {
    return (
        <footer>
            ...
            {/* copyrights */}
            <p className='max-padd-container bg-primary medium-14 py-2 px-8 rounded flexBetween mt-6'><span>2025 CollectionShopping</span><span>All rights reserved</span></p>
        </footer>
    )
}
